...
class _OrcamentoCalcadaState extends State<OrcamentoCalcada> {
  ...
  void _gerarMateriais() {
    ...
    if (metroQuadrados > 0) {
      setState(() {
        _materiais.addAll([
          MaterialItem(
              nomeMaterial: "Areia Média m³",
              quantidade: arredondarAcima((2 / 24) * metroQuadrados, 0.5)),
          MaterialItem(
              nomeMaterial: "Cimento de 50kg",
              quantidade: (8 / 24 * metroQuadrados).ceilToDouble()),
          MaterialItem(
              nomeMaterial: "Pedra Brita m³",
              quantidade: arredondarAcima((1.5 / 24) * metroQuadrados, 0.5)),
        ]);
      });
    }
  }
  ...
  Scaffold ScaffoldFormularioPadrao() {
    return Scaffold(
      appBar: AppBar(
        title: const Text("Orçamento de Calcada"),
      ),
      body: Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  TextFormField(
                    ...
                    decoration: InputDecoration(
                      hintText: 'Informe os m² da Calcada',
