...
class _OrcamentoTelhadoState extends State<OrcamentoTelhado> {
  ...
  void _gerarMateriais() {
    ...
    if (metroQuadrados > 0) {
      setState(() {
        _materiais.addAll([
          MaterialItem(nomeMaterial: "TELHA 1X2,44", quantidade: 14),
          MaterialItem(nomeMaterial: "VIGA 6X10 4,5 METROS", quantidade: 6),
          MaterialItem(nomeMaterial: "VIGA 6X10 3 METROS", quantidade: 1),
          MaterialItem(nomeMaterial: "VIGA 6X10 3,5 METROS", quantidade: 1),
          MaterialItem(
              nomeMaterial: "CAIBRO 5X5 DE 3,5 METROS", quantidade: 10),
          MaterialItem(
              nomeMaterial: "RIPA 2,5X15 CM DE LARGURA  DE 3,5 METROS",
              quantidade: 2),
          MaterialItem(
              nomeMaterial: "RIPA DE 2,5X15 CM DE LARGURA DE 4,5 METROS",
              quantidade: 2),
          MaterialItem(nomeMaterial: "PARAFUSO PARA TELHA", quantidade: 45),
          MaterialItem(nomeMaterial: "PREGO KG", quantidade: 2),
        ]);
      });
    }
  }
              ...
              child: Column(
                ...
                children: [
                  ...
                  TextFormField(
                    ...
                    decoration: InputDecoration(
                      hintText: 'Informe os m² do Telhado',
